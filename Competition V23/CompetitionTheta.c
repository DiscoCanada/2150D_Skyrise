...
#pragma config(Motor,  port3,           m_FR,          tmotorVex393HighSpeed_MC29, openLoop, driveLeft, encoderPort, I2C_4)
#pragma config(Motor,  port4,           m_BL,          tmotorVex393HighSpeed_MC29, openLoop, driveRight, encoderPort, I2C_2)
#pragma config(Motor,  port5,           m_BR,          tmotorVex393HighSpeed_MC29, openLoop, driveLeft, encoderPort, I2C_3)
#pragma config(Motor,  port6,           m_lftLB,       tmotorVex393_MC29, openLoop, encoderPort, I2C_8)
#pragma config(Motor,  port7,           m_rtLB,        tmotorVex393_MC29, openLoop, reversed, encoderPort, I2C_5)
#pragma config(Motor,  port8,           m_lftLT,       tmotorVex393_MC29, openLoop, encoderPort, I2C_7)
#pragma config(Motor,  port9,           m_rtLT,        tmotorVex393_MC29, openLoop, reversed, encoderPort, I2C_6)
