...
#pragma config(Sensor, I2C_5,  liftElevatorR,  sensorQuadEncoderOnI2CPort,    , AutoAssign)
#pragma config(Sensor, I2C_6,  liftArmR,       sensorQuadEncoderOnI2CPort,    , AutoAssign)
...
#pragma config(Motor,  port6,           liftElevatorR, tmotorVex393_MC29, openLoop, encoderPort, I2C_5)
#pragma config(Motor,  port7,           liftElevatorL, tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port8,           liftArmR,      tmotorVex393_MC29, openLoop, encoderPort, I2C_6)
#pragma config(Motor,  port9,           liftArmL,      tmotorVex393_MC29, openLoop)
...
#include "Constants.h"
#include "liftControls3.h"
#include "intakeControls.h"
#include "driveControls5.h"
