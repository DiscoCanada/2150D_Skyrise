...
const tSensors kGyroPort = driveTurn; // gyroscopic sensor port/name
...
float kTurnConversionFactor = SensorValue(fl)/kTicksPerRev*kWheelSize*pow(PI,2)*kDriveWidth/360; // Encoder value/kTurnConversionFactor
